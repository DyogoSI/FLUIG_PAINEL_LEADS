        ...
        <section class="filter-panel" style="margin: 18px 0 0 0; padding: 16px; border-radius: 12px; background-color: #ffffff; border: 1px solid #e2e8f0;">                          
            <div style="display: flex; flex-wrap: wrap; gap: 14px; align-items: center; justify-content: space-between;">                          
                <div style="display: flex; align-items: center; gap: 10px; flex: 1; min-width: 220px;">                          
                    <label style="font-weight: 600; color: #1f2937;">Status:</label>                          
                    <select class="filter-status" style="padding: 8px 10px; border-radius: 8px; border: 1px solid #cbd5e1; background: white;">                          
                ...
                <div style="display: flex; align-items: center; gap: 10px; flex: 1; min-width: 220px;">                          
                    <label style="font-weight: 600; color: #1f2937;">Método:</label>                          
                    <select class="filter-method" style="padding: 8px 10px; border-radius: 8px; border: 1px solid #cbd5e1; background: white;">                          
                        <option value="todos">Todos</option>                          
                ...
                <div style="display: flex; align-items: center; gap: 10px; flex: 1; min-width: 240px;">                          
                    <label style="font-weight: 600; color: #1f2937;">Buscar:</label>                          
                    <input type="text" class="filter-text" placeholder="Filtrar registros..." style="flex: 1; padding: 8px 10px; border-radius: 8px; border: 1px solid #cbd5e1; background: white;">                          
                </div>                          
            </div>          
        </section>                          
        ...
        <section class="table-container">                          
            <div class="table-actions">  
                ...
                <div class="default-actions" style="display: flex; gap: 12px; margin-left: auto;">
                    ...
                    <button type="button" class="btn-primary btn-toggle-selection" style="background-color: #4b5563; border: none;">                                                  
                        <i class="fa-solid fa-list-check"></i> Selecionar                      
                    </button>                                          
