        ...
        <header class="panel-header">
            ...
            <div class="header-right">
                ...
                <select name="limite" class="header-badge select-limite dropdown-select">
                    ...
                    <option value="100" style="color: black;">Exibir: 100</option>
                    <option value="200" style="color: black;">Exibir: 200</option>
            ...
            <div class="table-actions">
                ...
                <div class="selection-actions" style="display: none; width: 100%; align-items: center; background-color: #eff6ff; padding: 6px 16px; border-radius: 8px; border: 1px solid #bfdbfe;">
                    ...
                    <div style="display: flex; gap: 12px; align-items: center;">
                        ...
                        <button type="button" class="btn-iniciar-classificacao" style="display: none; background-color: #6366f1; color: white; border: none; padding: 8px 14px; border-radius: 6px; font-size: 13px; font-weight: 600; cursor: pointer;">
                            <i class="fa-solid fa-diagram-project" style="margin-right: 4px;"></i> Iniciar Classificação
                        </button>
